    ...
    <>
      <GuestListContainer>
        <GuestList className="color1">
          <GuestLeft>
            <GuestPicSpan>
              <GuestPic src={require("../../Assets/Rectangle 20695.jpg")} />
            </GuestPicSpan>
            <GuestNameDiv>
              <GuestNameInput
                type="text"
          ...
          <GuestRight className="click">
            <EditSpan className="h">
              <Editimg src={require("../../Assets/fa-solid_pen.svg").default} />
            </EditSpan>
            ...
            <DotsSpan id="show_hide1" className="show">
              <DotsImg
                src={require("../../Assets/bi_three-dots-vertical.svg").default}
              />
            </DotsSpan>
          </GuestRight>
        </GuestList>
        ...
        <GuestList className="color1 color2">
          <GuestLeft>
            <GuestPicSpan>
              <GuestPic src={require("../../Assets/Rectangle 20696.jpg")} />
            </GuestPicSpan>
            <GuestNameDiv>
              <GuestNameInput
                type="text"
